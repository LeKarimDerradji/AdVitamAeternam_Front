      ...
      {ipfs && web3State.chainId === 4 ? (
        <Container mt="30" mb="30">
          <Box mb="10" textAlign="center">
            ...
            <Text fontSize='30px'>
              Here you can retrive the data that you immortalized, in the form of a cid, uri or the address of your nft.
              To find your token ID, you can go on etherscan.
            </Text>
          </Box>
          ...
          <Button mt='5px=
          ' colorScheme='blue' onClick={handleClickGetURI}>Get URI</Button>
          <Text>{uri}</Text>
          ...
          <Button mt='5px=
          ' colorScheme='blue' onClick={handleOnClickResolveCid}>Get Metadata From IPFS CID</Button>
